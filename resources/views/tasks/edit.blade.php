                    ...
                    <form @submit.prevent="submitForm()" class="space-y-6">
                        ...
                        <div class="flex items-center justify-end space-x-4">
                            ...
                            <x-primary-button :disabled="isSubmitting">
                                <span x-show="!isSubmitting">Actualizar Tarea</span>
                                <span x-show="isSubmitting">Actualizando...</span>
                            </x-primary-button>
                        </div>
                    </form>
                </div>
        ...
        function taskForm() {
            return {
                ...
                validateForm() {
                    ...
                    // Validar fecha de vencimiento (en edición no hay restricción de fecha futura)
                    if (this.form.due_date) {
                        const dueDate = new Date(this.form.due_date);
                        if (isNaN(dueDate.getTime())) {
                            this.fieldErrors.due_date = 'La fecha de vencimiento no es válida';
                            this.errors.push('La fecha de vencimiento no es válida');
                        }
                    }
                    ...
                    try {
                        ...
                        if (response.ok) {
                            ...
                            if (data.errors) {
                                ...
                                this.errors = [data.message || 'Error al actualizar la tarea'];
                            }
                        }
                    } catch (error) {
